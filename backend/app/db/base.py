...
engine=create_async_engine(settings.DATABASE_URL, future=True, echo=True) #makes connection with database (basically connects python with any database PostgreSQL/MySQL/SQLite)
